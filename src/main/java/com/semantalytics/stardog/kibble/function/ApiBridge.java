...
public final class ApiBridge extends AbstractExpression implements UserDefinedFunction {
    ...
    private ApiBridge(final ApiBridge call) {
        super(call);
    }
    ...
    @Override
    public ApiBridge copy() {
        return new ApiBridge(this);
    }
