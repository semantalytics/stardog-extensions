...
public class ScoreFromAllWithLatinScript extends AbstractExpression implements UserDefinedFunction {

    private static SoftReference<LanguageDetector> detector;

    public ScoreFromAllWithLatinScript() {
        super(new Expression[0]);
    }

    public ScoreFromAllWithLatinScript(final ScoreFromAllWithLatinScript detectFrom) {
        super(detectFrom);
    }

    @Override
    public String getName() {
        return LanguageVocabulary.scoreFromAllWithLatinScript.toString();
    }
    ...
    public Function copy() {
        return new ScoreFromAllWithLatinScript(this);
    }
