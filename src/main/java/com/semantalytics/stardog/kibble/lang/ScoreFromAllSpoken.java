...
public class ScoreFromAllSpoken extends AbstractExpression implements UserDefinedFunction {

    private static SoftReference<LanguageDetector> detector;

    public ScoreFromAllSpoken() {
        super(new Expression[0]);
    }

    public ScoreFromAllSpoken(final ScoreFromAllSpoken detectFrom) {
        super(detectFrom);
    }

    @Override
    public String getName() {
        return LanguageVocabulary.scoreFromAllSpoken.toString();
    }
    ...
    public Function copy() {
        return new ScoreFromAllSpoken(this);
    }
