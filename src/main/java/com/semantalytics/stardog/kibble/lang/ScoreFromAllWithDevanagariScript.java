...
public class ScoreFromAllWithDevanagariScript extends AbstractExpression implements UserDefinedFunction {

    private static SoftReference<LanguageDetector> detector;

    public ScoreFromAllWithDevanagariScript() {
        super(new Expression[0]);
    }

    public ScoreFromAllWithDevanagariScript(final ScoreFromAllWithDevanagariScript detectFrom) {
        super(detectFrom);
    }

    @Override
    public String getName() {
        return LanguageVocabulary.scoreFromAllWithDevanagariScript.toString();
    }
    ...
    public Function copy() {
        return new ScoreFromAllWithDevanagariScript(this);
    }
