...
public class ScoreFromAllWithCyrillicScript extends AbstractExpression implements UserDefinedFunction {

    private static SoftReference<LanguageDetector> detector;

    public ScoreFromAllWithCyrillicScript() {
        super(new Expression[0]);
    }

    public ScoreFromAllWithCyrillicScript(final ScoreFromAllWithCyrillicScript detectFrom) {
        super(detectFrom);
    }

    @Override
    public String getName() {
        return LanguageVocabulary.scoreFromAllWithCyrillicScript.toString();
    }
    ...
    public Function copy() {
        return new ScoreFromAllWithCyrillicScript(this);
    }
