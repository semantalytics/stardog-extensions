...
public class Score extends AbstractExpression implements UserDefinedFunction {
    ...
    public Score(final Score detectFrom) {
        super(detectFrom);
    }

    @Override
    public String getName() {
        return LanguageVocabulary.score.toString();
    }
