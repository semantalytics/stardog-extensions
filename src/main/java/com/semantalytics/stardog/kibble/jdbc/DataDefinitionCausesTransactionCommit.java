...
public class DataDefinitionCausesTransactionCommit extends AbstractFunction implements UserDefinedFunction {
    ...
    public DataDefinitionCausesTransactionCommit() {
        super(1, JdbcVocabulary.dataDefinitionCausesTransactionCommit.stringValue());
    }
    ...
    protected ValueOrError internalEvaluate(final Value... values) {
        ...
        if (iri.isPresent()) {
            try (final Connection connection = DriverManager.getConnection(iri.get())) {
                ...
                return ValueOrError.Boolean.of(metadata.dataDefinitionCausesTransactionCommit());
    ...
    public String toString() {
        return JdbcVocabulary.dataDefinitionCausesTransactionCommit.name();
    }
}
