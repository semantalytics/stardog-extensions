...
public class MaxLogicalLobSize extends AbstractFunction implements UserDefinedFunction {
    ...
    public MaxLogicalLobSize() {
        super(1, JdbcVocabulary.maxLogicalLobSize.stringValue());
    }

    public MaxLogicalLobSize(final MaxLogicalLobSize executeDouble) {
        super(executeDouble);
    }
    ...
    @Override
    public MaxLogicalLobSize copy() {
        return new MaxLogicalLobSize(this);
    }
    ...
    public String toString() {
        return JdbcVocabulary.maxLogicalLobSize.name();
    }
