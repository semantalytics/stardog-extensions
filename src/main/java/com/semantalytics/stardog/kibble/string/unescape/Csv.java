...
import static org.apache.commons.text.StringEscapeUtils.unescapeCsv;

public final class Csv extends AbstractFunction implements StringFunction {

    protected Csv() {
        super(1, UnescapeVocabulary.csv.stringValue());
    }
    ...
    protected ValueOrError internalEvaluate(final Value... values) {
        ...
        if(assertStringLiteral(values[0])) {
            ...
            return ValueOrError.General.of(literal(unescapeCsv(string)));
        } else {
