...
public class During extends AbstractFunction implements UserDefinedFunction {

    public During() {
        super(2, Constants.NAMESPACE + "during");
    }

    public During(final During during) {
        super(during);
    }
    ...
    public ValueOrError internalEvaluate(final Value... values) {
        try {
            ...
            if(entity1.isPresent() && entity2.isPresent()) {
                return ValueOrError.General.of(literal(TemporalFunction.during(entity1.get(), entity2.get())));
            } else {
