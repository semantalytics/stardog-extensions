...
public class Crosses extends AbstractFunction implements UserDefinedFunction {

    public Crosses() {
        super(2, Constants.NAMESPACE + "crosses");
    }

    public Crosses(final Crosses crosses) {
        super(crosses);
    }
