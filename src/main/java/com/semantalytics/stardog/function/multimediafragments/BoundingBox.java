    ...
    public ValueOrError internalEvaluate(final Value... values) {
        ...
        if(Entities.haveComparable(values)) {
            ...
            try {
                ...
                res[0] = SpatialFunction.getBoundingBox(entities.stream().toArray(SpatialEntity[]::new)).stringValue();
            ...
            try {
                ...
                res[1] = TemporalFunction.getBoundingBox(entities.stream().toArray(TemporalEntity[]::new)).stringValue();
            } catch (IllegalArgumentException | MediaFragmentURISyntaxException | ParseException e) {
            }
