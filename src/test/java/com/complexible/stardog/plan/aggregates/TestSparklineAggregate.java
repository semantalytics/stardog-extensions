...
public class TestSparklineAggregate extends AbstractStardogTest {
    ...
    public void testOneArg() {
        ...
        final String aQuery = sparqlPrefix +
                " select ?result where { bind(vis:spark(1) as ?result) }";
    ...
    public void testIndexTooLarge() {
        ...
        final String aQuery = sparqlPrefix +
                " select ?result where { bind(vis:spark(8) as ?result) }";
    ...
    public void testTooFewAargs() {
        ...
        final String aQuery = sparqlPrefix +
                " select ?result where { bind(vis:spark() as ?result) }";
