...
public class TestXsi extends AbstractStardogTest {
    ...
    public void testOneArg() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:xsi(\"He didn't say, \\\"Stop!\\\"\") AS ?result) }";
    ...
    public void testEmptyString() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:xsi(\"\") as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:xsi(\"one\", \"two\") as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:xsi(1) as ?result) }";
