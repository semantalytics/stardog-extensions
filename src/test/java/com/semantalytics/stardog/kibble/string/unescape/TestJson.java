...
public class TestJson extends AbstractStardogTest {
    ...
    public void testOneArg() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(unescape:json(\"He didn't say, \\\"Stop!\\\"\") AS ?result) }";
    ...
    public void testEmptyString() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(unescape:json(\"\") as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(unescape:json(\"one\", \"two\") as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(unescape:json(1) as ?result) }";
