...
@RunWith(Suite.class)
@SuiteClasses({
        com.semantalytics.stardog.kibble.string.escape.TestEcmaScript.class,
        com.semantalytics.stardog.kibble.string.escape.TestHtml3.class,
        com.semantalytics.stardog.kibble.string.escape.TestHtml4.class,
        com.semantalytics.stardog.kibble.string.escape.TestJava.class,
        com.semantalytics.stardog.kibble.string.escape.TestJson.class,
        com.semantalytics.stardog.kibble.string.escape.TestXml.class,
        com.semantalytics.stardog.kibble.string.escape.TestXsi.class,
        com.semantalytics.stardog.kibble.string.escape.TestCsv.class,
        com.semantalytics.stardog.kibble.string.escape.TestEcmaScript.class,
        com.semantalytics.stardog.kibble.string.escape.TestHtml3.class,
        com.semantalytics.stardog.kibble.string.escape.TestHtml4.class,
        com.semantalytics.stardog.kibble.string.escape.TestJava.class,
