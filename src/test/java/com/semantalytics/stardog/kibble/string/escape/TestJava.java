...
public class TestJava extends AbstractStardogTest {
    ...
    public void testOneArg() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:java(\"He didn't say, \\\"Stop!\\\"\") AS ?result) }";
    ...
    public void testEmptyString() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:java(\"\") as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:java(\"one\", \"two\") as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = sparqlPrefix +
                "select ?result where { bind(escape:java(1) as ?result) }";
