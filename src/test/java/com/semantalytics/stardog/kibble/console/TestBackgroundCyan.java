...
public class TestBackgroundCyan extends AbstractStardogTest {
    ...
    public void testNoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:backgroundCyan() AS ?result) }";
    ...
    public void testOneArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:backgroundCyan(\"Stardog\") AS ?result) }";
    ...
    public void testTwoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:backgroundCyan(\"one\", \"two\") AS ?result) }";
    ...
    public void testOneArgInteger() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:backgroundCyan(1) AS ?result) }";
