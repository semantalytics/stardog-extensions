...
public class TestItalicOff extends AbstractStardogTest {
    ...
    public void testNoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:italicOff() AS ?result) }";
        ...
        try (final SelectQueryResult aResult = connection.select(aQuery).execute()) {
            ...
            assertThat(aLiteralValue.label()).isEqualTo("\u001b[23m");
    ...
    public void testTooMaryArgs() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:italicOff(\"Stardog\") as ?result) }";
