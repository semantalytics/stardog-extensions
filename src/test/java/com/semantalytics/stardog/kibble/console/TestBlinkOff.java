...
public class TestBlinkOff extends AbstractStardogTest {
    ...
    public void testNoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:blinkOff() AS ?result) }";
    ...
    public void testTooMaryArgs() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:blinkOff(\"Stardog\") as ?result) }";
