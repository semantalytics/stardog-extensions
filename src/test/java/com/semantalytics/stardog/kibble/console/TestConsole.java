...
public class TestConsole extends AbstractStardogTest {
    ...
    public void testNoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:console() AS ?result) }";
    ...
    public void testOneArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:console(\"Stardog\") AS ?result) }";
    ...
    public void testTwoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:console(\"one\", \"two\") AS ?result) }";
    ...
    public void testOneArgInteger() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:console(1) AS ?result) }";
