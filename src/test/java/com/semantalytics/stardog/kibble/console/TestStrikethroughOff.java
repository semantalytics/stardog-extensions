...
public class TestStrikethroughOff extends AbstractStardogTest {
    ...
    public void testNoArg() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:strikethroughOff() AS ?result) }";
    ...
    public void testTooMaryArgs() {
        ...
        final String aQuery = consoleSparqlPrefix +
                "select ?result where { bind(console:strikethroughOff(\"Stardog\") as ?result) }";
