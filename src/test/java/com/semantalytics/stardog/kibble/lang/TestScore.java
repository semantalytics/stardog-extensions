...
public class TestScore extends AbstractStardogTest {
    ...
    public void testDetectAllGermanPhrase() {
        ...
        final String aQuery = LanguageVocabulary.sparqlPrefix("lang") +
                " " + ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { bind(array:toString(lang:score(\"guten morgan\")) AS ?result) }";
    ...
    public void testTooFewArgs() {
        ...
        final String aQuery = LanguageVocabulary.sparqlPrefix("lang") +
                    "select ?result where { bind(lang:score() as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = LanguageVocabulary.sparqlPrefix("lang") +
                    "select ?result where { bind(lang:score(\"one\", \"two\") as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = LanguageVocabulary.sparqlPrefix("lang") +
                    "select ?result where { bind(lang:score(1) as ?result) }";
