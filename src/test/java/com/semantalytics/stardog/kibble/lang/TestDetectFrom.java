...
public class TestDetectFrom extends AbstractStardogTest {
    ...
    public void testDetectAllEnglishPhrase() {
        ...
        final String aQuery = LanguageVocabulary.sparqlPrefix("lang") +
                    "select ?result where { bind(lang:detectFrom(\"Stardog graph database\", \"english\", \"german\") AS ?result) }";
    ...
    public void testDetectAllGermanPhrase() {
        ...
        final String aQuery = LanguageVocabulary.sparqlPrefix("lang") +
                "select ?result where { bind(lang:detectFrom(\"guten morgan\", \"english\", \"german\") AS ?result) }";
