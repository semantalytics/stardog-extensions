...
public class TemporalMeetsTest extends AbstractStardogTest {


    @Test
    public void testMeetsFunction() throws IOException {
        ...
        String t5 = list.get(1).literal("t1").get().label();
        String t6 = list.get(1).literal("t2").get().label();
