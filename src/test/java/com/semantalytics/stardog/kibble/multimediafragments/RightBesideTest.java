...
public class RightBesideTest extends AbstractStardogTest {


    @Test
    public void testRightBesideFunction() throws IOException {
        ...
        Assert.assertEquals("true",list.get(0).literal("test").get().label());
        Assert.assertEquals("false",list.get(1).literal("test").get().label());
        Assert.assertEquals("true",list.get(2).literal("test").get().label());
