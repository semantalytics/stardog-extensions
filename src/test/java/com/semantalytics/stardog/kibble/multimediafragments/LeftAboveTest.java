...
public class LeftAboveTest extends AbstractStardogTest {

    @Test
    public void testIsLeftAboveFunction() throws IOException {
        ...
        Assert.assertEquals("true",list.get(3).literal("test").get().label());
        }
    }
