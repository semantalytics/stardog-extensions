...
public class TestIndexOf extends AbstractStardogTest {
    ...
    public void testTwoArg() {
        ...
        final String aQuery =ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:indexOf(array:of(3, 2, 3), 3) as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:indexOf(1, 3) as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
            "select ?result where { unnest(array:indexOf(array:of(1, 2, 3), 3, 4) as ?result) }";
