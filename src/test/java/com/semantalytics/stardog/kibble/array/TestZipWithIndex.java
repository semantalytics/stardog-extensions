...
public class TestZipWithIndex extends AbstractStardogTest {

    @Test
    public void testOneArg() {

        final String aQuery =ArrayVocabulary.sparqlPrefix("array") +
                "select (array:index(?result, array:ordinal(1)) as ?resultIndex1) (array:index(?result, array:ordinal(2)) as ?resultIndex2) where { unnest(array:zipWithIndex(array:of(3, 4)) as ?result) }";
        ...
        try(final SelectQueryResult aResult = connection.select(aQuery).execute()) {
            ...
            assertThat(Literal.intValue(aLiteral11)).isEqualTo(0);
            ...
            assertThat(Literal.intValue(aLiteral21)).isEqualTo(1);
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
        "select (array:index(?result, array:ordinal(1)) as ?resultIndex1) (array:index(?result, array:ordinal(2)) as ?resultIndex2) where { unnest(array:zipWithIndex(1) as ?result) }";
    ...
    @Test
    public void TooManyArgsShouldReturnNoResults() {

        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
            "select (array:index(?result, array:ordinal(1)) as ?resultIndex1) (array:index(?result, array:ordinal(2)) as ?resultIndex2) where { unnest(array:zipWithIndex(array:of(3, 4), 5) as ?result) }";
