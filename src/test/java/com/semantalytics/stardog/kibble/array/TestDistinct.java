...
public class TestDistinct extends AbstractStardogTest {

    @Test
    public void testOneArg() {

        final String aQuery =ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:distinct(array:of(1, 2, 3, 3)) as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
            "select ?result where { unnest(array:distinct(1) as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
            "select ?result where { unnest(array:distinct(array:of(1, 2, 3, 3), 2) as ?result) }";
