...
public class TestOrdinal extends AbstractStardogTest {

    @Test
    public void testOneArg() {

        final String aQuery =ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { bind(array:ordinal(1) as ?result) }";
    ...
    public void tooManyArgumentsShouldNotReturnAnyResults() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { bind(array:ordinal(1, 2) as ?result) }";
