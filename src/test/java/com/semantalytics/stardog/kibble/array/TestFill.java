...
public class TestFill extends AbstractStardogTest {

    @Test
    public void testTwoArg() {

        final String aQuery =ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:fill(1, 2) as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:fill(1, 2, 3) as ?result) }";
