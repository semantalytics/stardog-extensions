...
public class TestRemoveLast extends AbstractStardogTest {

    @Test
    public void testOneArg() {

        final String aQuery =ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:removeLast(array:of(1, 2, 3)) as ?result) }";
    ...
    public void testWrongTypeFirstArg() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
            "select ?result where { unnest(array:removeLast(1) as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = ArrayVocabulary.sparqlPrefix("array") +
                "select ?result where { unnest(array:removeLast(array:of(1, 2, 3), 4) as ?result) }";
