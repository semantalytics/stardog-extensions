...
public class TestNGram extends AbstractStardogTest {
    ...
    @Test
    public void testWrongNumberOfArgsThree() {
        final String aQuery =ArrayVocabulary.sparqlPrefix("array") + " " + StringVocabulary.sparqlPrefix("string") +
    ...
    @Test
    public void testWrongNumberOfArgsFive() {
        final String aQuery =ArrayVocabulary.sparqlPrefix("array") + " " + StringVocabulary.sparqlPrefix("string") +
                " select (array:toString(array:ngram(2, ?array, 3, 4, 5)) as ?result) where { bind(string:charactersOf(\"Stardog\") as ?array) }";
    ...
    public void testFourArg() {
        final String aQuery =ArrayVocabulary.sparqlPrefix("array") + " " + StringVocabulary.sparqlPrefix("string") +
                " select (array:toString(array:ngram(2, ?array, \"three\", \"four\")) as ?result) where { bind(string:charactersOf(\"Stardog\") as ?array) }";
        ...
        try(final SelectQueryResult aResult = connection.select(aQuery).execute()) {
            ...
            assertThat(aPossibleLiteral).isPresent();
            final Literal aLiteral = aPossibleLiteral.get();
            assertThat(aLiteral.label()).isEqualTo("[ [ \"three\"^^<http://www.w3.org/2001/XMLSchema#string> \"S\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"S\"^^<http://www.w3.org/2001/XMLSchema#string> \"t\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"t\"^^<http://www.w3.org/2001/XMLSchema#string> \"a\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"a\"^^<http://www.w3.org/2001/XMLSchema#string> \"r\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"r\"^^<http://www.w3.org/2001/XMLSchema#string> \"d\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"d\"^^<http://www.w3.org/2001/XMLSchema#string> \"o\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"o\"^^<http://www.w3.org/2001/XMLSchema#string> \"g\"^^<http://www.w3.org/2001/XMLSchema#string> ] [ \"g\"^^<http://www.w3.org/2001/XMLSchema#string> \"three\"^^<http://www.w3.org/2001/XMLSchema#string> ] ]");
            assertThat(aResult).isExhausted().withFailMessage("Should have no more results");
        }
    }
}
