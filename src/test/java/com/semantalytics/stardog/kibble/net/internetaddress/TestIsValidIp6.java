...
public class TestIsValidIp6 extends AbstractStardogTest {
    ...
    public void testOneArgTrue() {
            ...
            final String aQuery = InternetAddressVocabulary.sparqlPrefix("ip") +
                    " select ?result where { bind(ip:isValidIp6(\"192.168.0.1\") as ?result) }";
    ...
    public void testOneArgFalse() {
        ...
        final String aQuery = InternetAddressVocabulary.sparqlPrefix("ip") +
                " select ?result where { bind(ip:isValidIp6(\"2001:0db8:85a3:0000:0000:8a2e:0370:7334\") as ?result) }";
    ...
    public void testTooManyArgs() {
        ...
        final String aQuery = InternetAddressVocabulary.sparqlPrefix("ip") +
                "select ?result where { bind(ip:isValidIp6(\"one\", \"two\") as ?result) }";
    ...
    public void testTooFewArgs() {
        ...
        final String aQuery = InternetAddressVocabulary.sparqlPrefix("ip") +
                "select ?result where { bind(ip:isValidIp6() as ?result) }";
    ...
    public void testWrongTypeFistArg() {
        ...
        final String aQuery = InternetAddressVocabulary.sparqlPrefix("ip") +
                "select ?result where { bind(ip:isValidIp6(1) as ?result) }";
